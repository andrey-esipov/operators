...
export const STAGES: Record<ScenarioId, StageConfig> = {
  'pre-pmf': {
    ...
    floor: { color: 0x2b2622, roughness: 0.42, metalness: 0.1, reflectivity: 0.5, gridColor: 0xf77f00, gridIntensity: 0.55, pattern: 1 },
    shaftColor: 0xffb05a,
    shaftIntensity: 0.5,
  ...
  hypergrowth: {
    ...
    lighting: P(
      [0xd8f4ff, 3.7, [-0.42, 0.8, 0.44]],
      [0x2a6fc0, 1.42, [0.7, 0.28, 0.5]],
      [0x33e0ff, 3.2, [0.24, 0.42, -0.88]],
      [0x1c3654, 0.95],
      [0x081726, 0.014],
      0x04101c,
      1.08,
    ...
    practicals: [
      ...
      { pos: [0, 3.4, -12.4], color: 0xffb060, intensity: 32, distance: 17 },
      { pos: [0, 12.5, -12.4], color: 0x9fd8ff, intensity: 15, distance: 20 },
    ],
  },
  plateau: {
    id: 'plateau',
    ...
    floor: { color: 0x201b2b, roughness: 0.3, metalness: 0.3, reflectivity: 0.82, gridColor: 0xf72585, gridIntensity: 1.0, pattern: 0 },
    shaftColor: 0xc766ff,
    shaftIntensity: 0.62,
  ...
  'ai-native': {
    ...
    lighting: P(
      [0xcdfaff, 3.6, [-0.4, 0.82, 0.4]],
      [0x1a6a9a, 1.36, [0.72, 0.26, 0.5]],
      [0x2ee6b4, 2.6, [0.22, 0.4, -0.89]],
      [0x123a4e, 0.92],
      [0x04141f, 0.016],
      0x02101a,
      1.09,
    ),
    floor: { color: 0x0a2a3c, roughness: 0.18, metalness: 0.6, reflectivity: 0.88, gridColor: 0x00e5ff, gridIntensity: 1.35, pattern: 3 },
    shaftColor: 0x59ffe0,
    shaftIntensity: 0.8,
  ...
  monetization: {
    ...
    floor: { color: 0x1c1410, roughness: 0.26, metalness: 0.42, reflectivity: 0.74, gridColor: 0xffd60a, gridIntensity: 0.72, pattern: 4 },
    shaftColor: 0xffd97a,
    shaftIntensity: 0.66,
  ...
  crisis: {
    ...
    floor: { color: 0x241010, roughness: 0.28, metalness: 0.3, reflectivity: 0.72, gridColor: 0xef233c, gridIntensity: 0.85, pattern: 2 },
    shaftColor: 0xff6a5a,
    shaftIntensity: 0.85,
  ...
  distribution: {
    ...
    floor: { color: 0x1b1d24, roughness: 0.34, metalness: 0.28, reflectivity: 0.6, gridColor: 0xffd60a, gridIntensity: 0.7, pattern: 5 },
    shaftColor: 0xffc36a,
    shaftIntensity: 0.75,
